...
?>
    ...
    <div class="space"></div>
        ...
        <div class="btn">
            <ul> 
                <li>
                    <h4 class="c-link"> Introduzione</h4>
                </li>
               <li>
                   <h4 class="c-link"> Norme sulla Privacy</h4>
               </li>
               <li>
                   <h4 class="c-link" > Termini di Servizio</h4>
               </li>         
               <li>
                   <h4 class="c-link" > Tecnologie</h4>
               </li>
               <li>
                   <h4 class="c-link" > Domande Frequenti</h4>
               </li>
            </ul>  
        </div>  
        <hr>
